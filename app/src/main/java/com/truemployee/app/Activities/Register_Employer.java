...
public class Register_Employer extends AppCompatActivity {
    ...
    private Activity mActivity = Register_Employer.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employer_but.setColorFilter(activecolor);
        employee_but.setColorFilter(disablecolor);





        employee_but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Register_Employer.this , Register.class);
        ...
        btnSendConfirmationCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!validatepassword(password.getText().toString())){
                    ...
                    Utility.showToast(Register_Employer.this, "This password is too short. It must contain at least 8 characters.");
                }
                if(cpasssw.isEmpty()){
                    ...
                    Utility.showToast(Register_Employer.this,  " Please make sure your Password and Confirm Password are same" + "Password = " + password.getText() + "   Confirm Password = " + confirm_password.getText() );
                ...
                if (validate()  && !passw.isEmpty() && !cpasssw.isEmpty() && confirm_password.getText().toString().equals(password.getText().toString()) && validatepassword(password.getText().toString())) {
                    ...
                    myPrefEditor.putString("Full_Name","not available");
                    myPrefEditor.putString("Mother_Name","not available");
                    myPrefEditor.putString("CNIC","not available");
            ...
            if (resultCode == RESULT_OK) {
                if (data != null) {
                    if (data.hasExtra(AppConstant.COUNTRY)) {
                        ...
                        this.mSelectedCountry = country;
                        setPhoneNumberHint();
                        MainActivity.usertype = "Employer";
                        etCountryCode.setText("+" + country.getPhoneCode() + "");
                        imgFlag.setImageResource(CountryUtils.getFlagDrawableResId(country.getIso()));
                    }
                }
