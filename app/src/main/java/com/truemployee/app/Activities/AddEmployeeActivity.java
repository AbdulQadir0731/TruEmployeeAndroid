        ...
        location_lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Autocomplete.IntentBuilder(
                        ...
                        .build(AddEmployeeActivity.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE && resultCode == Activity.RESULT_OK  && changeimageselected  ) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(AddEmployeeActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
            }

        }else {
            Toast.makeText(AddEmployeeActivity.this, "You haven't picked Image",Toast.LENGTH_LONG).show();
        }
